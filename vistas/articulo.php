          ...
          <div class="panel-body" id="formularioregistros">
            <form name="formulario" id="formulario" method="POST">
              ...
              <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <img src="" id="imagenmuestra" style="width:150px;height:120px;margin-top:8px;">
              </div>

              <!-- CÓDIGO (alineado en una sola línea con los botones) -->
              <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <label>Código:</label>
                ...
                <!-- Previsualización debajo, sin mover IDs -->
